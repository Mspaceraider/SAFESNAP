...
//sampler sampler deviceTexSmpSC 2:18
...
//texture texture2D deviceTex 2:1:2:18
...
uniform vec4 deviceTexSize;
uniform vec4 deviceTexView;
uniform mat3 deviceTexTransform;
uniform vec4 deviceTexUvMinMax;
uniform vec4 deviceTexBorderColor;
uniform vec4 baseTexSize;
uniform vec4 baseTexView;
uniform mat3 baseTexTransform;
uniform vec4 baseTexUvMinMax;
uniform vec4 baseTexBorderColor;
uniform vec2 Port_Scale_N010;
uniform vec2 Port_Center_N010;
...
#endif
#ifndef deviceTexHasSwappedViews
#define deviceTexHasSwappedViews 0
#elif deviceTexHasSwappedViews==1
#undef deviceTexHasSwappedViews
#define deviceTexHasSwappedViews 1
#endif
#ifndef deviceTexLayout
#define deviceTexLayout 0
#endif
...
#endif
#ifndef SC_USE_UV_TRANSFORM_deviceTex
#define SC_USE_UV_TRANSFORM_deviceTex 0
#elif SC_USE_UV_TRANSFORM_deviceTex==1
#undef SC_USE_UV_TRANSFORM_deviceTex
#define SC_USE_UV_TRANSFORM_deviceTex 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_deviceTex
#define SC_SOFTWARE_WRAP_MODE_U_deviceTex -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_deviceTex
#define SC_SOFTWARE_WRAP_MODE_V_deviceTex -1
#endif
#ifndef SC_USE_UV_MIN_MAX_deviceTex
#define SC_USE_UV_MIN_MAX_deviceTex 0
#elif SC_USE_UV_MIN_MAX_deviceTex==1
#undef SC_USE_UV_MIN_MAX_deviceTex
#define SC_USE_UV_MIN_MAX_deviceTex 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_deviceTex
#define SC_USE_CLAMP_TO_BORDER_deviceTex 0
#elif SC_USE_CLAMP_TO_BORDER_deviceTex==1
#undef SC_USE_CLAMP_TO_BORDER_deviceTex
#define SC_USE_CLAMP_TO_BORDER_deviceTex 1
#endif
...
#endif
vec2 l9_0=((varPackedTex.xy-Port_Center_N010)*Port_Scale_N010)+Port_Center_N010;
int l9_1;
#if (deviceTexHasSwappedViews)
{
...
#endif
vec4 l9_2=sc_SampleTextureBiasOrLevel(deviceTexDims.xy,deviceTexLayout,l9_1,l9_0,(int(SC_USE_UV_TRANSFORM_deviceTex)!=0),deviceTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_deviceTex,SC_SOFTWARE_WRAP_MODE_V_deviceTex),(int(SC_USE_UV_MIN_MAX_deviceTex)!=0),deviceTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_deviceTex)!=0),deviceTexBorderColor,0.0,deviceTex);
int l9_3;
...
#endif
vec4 l9_4=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,l9_3,l9_0,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
float l9_5=l9_2.w*l9_4.x;
vec4 l9_6=vec4(l9_2.x,l9_2.y,l9_2.z,vec4(0.0).w);
l9_6.w=l9_5;
...
{
l9_10=clamp(dot(l9_6.xyz,vec3(l9_5)),0.0,1.0);
}
#else
{
float l9_11;
...
{
l9_12=(1.0-dot(l9_6.xyz,vec3(0.33333001)))*l9_5;
}
#else
{
float l9_13;
...
{
l9_13=(1.0-clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0))*l9_5;
}
#else
{
float l9_14;
...
{
l9_14=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0)*l9_5;
}
#else
{
float l9_15;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_16=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0)*l9_5;
}
#else
{
float l9_17;
...
{
l9_17=dot(l9_6.xyz,vec3(0.33333001))*l9_5;
}
#else
{
float l9_18;
...
#endif
vec3 l9_30=mix(l9_28.xyz,definedBlend(l9_28.xyz,l9_6.xyz).xyz,vec3(l9_5));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_32=vec4(mix(vec3(1.0),l9_6.xyz,vec3(l9_5)),l9_5);
}
#else
{
vec4 l9_33;
