...
//sampler sampler deviceTexSmpSC 2:24
...
//texture texture2D deviceTex 2:5:2:24
...
//}
//ubo int UserUniforms 2:35:4368 {
...
//float4 deviceTexSize 4080
//float4 deviceTexDims 4096
//float4 deviceTexView 4112
//float3x3 deviceTexTransform 4128
//float4 deviceTexUvMinMax 4176
//float4 deviceTexBorderColor 4192
//float4 baseTexSize 4208
//float4 baseTexDims 4224
//float4 baseTexView 4240
//float3x3 baseTexTransform 4256
//float4 baseTexUvMinMax 4304
//float4 baseTexBorderColor 4320
//float2 Port_Scale_N010 4336
//float2 Port_Center_N010 4344
//float depthRef 4352
//}
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 1074
//spec_const int SC_SOFTWARE_WRAP_MODE_U_deviceTex 1075
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 1076
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 1077
//spec_const int SC_SOFTWARE_WRAP_MODE_V_deviceTex 1078
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 1079
//spec_const int baseTexLayout 1080
//spec_const int deviceTexLayout 1081
...
constant bool SC_USE_CLAMP_TO_BORDER_deviceTex [[function_constant(1032)]];
constant bool SC_USE_CLAMP_TO_BORDER_deviceTex_tmp = is_function_constant_defined(SC_USE_CLAMP_TO_BORDER_deviceTex) ? SC_USE_CLAMP_TO_BORDER_deviceTex : false;
...
constant bool SC_USE_UV_MIN_MAX_deviceTex [[function_constant(1035)]];
constant bool SC_USE_UV_MIN_MAX_deviceTex_tmp = is_function_constant_defined(SC_USE_UV_MIN_MAX_deviceTex) ? SC_USE_UV_MIN_MAX_deviceTex : false;
...
constant bool SC_USE_UV_TRANSFORM_deviceTex [[function_constant(1038)]];
constant bool SC_USE_UV_TRANSFORM_deviceTex_tmp = is_function_constant_defined(SC_USE_UV_TRANSFORM_deviceTex) ? SC_USE_UV_TRANSFORM_deviceTex : false;
...
constant bool baseTexHasSwappedViews [[function_constant(1041)]];
...
constant bool deviceTexHasSwappedViews [[function_constant(1042)]];
constant bool deviceTexHasSwappedViews_tmp = is_function_constant_defined(deviceTexHasSwappedViews) ? deviceTexHasSwappedViews : false;
...
constant int SC_SOFTWARE_WRAP_MODE_U_baseTex [[function_constant(1074)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_deviceTex [[function_constant(1075)]];
constant int SC_SOFTWARE_WRAP_MODE_U_deviceTex_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_U_deviceTex) ? SC_SOFTWARE_WRAP_MODE_U_deviceTex : -1;
...
constant int SC_SOFTWARE_WRAP_MODE_V_deviceTex [[function_constant(1078)]];
constant int SC_SOFTWARE_WRAP_MODE_V_deviceTex_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_V_deviceTex) ? SC_SOFTWARE_WRAP_MODE_V_deviceTex : -1;
constant int SC_SOFTWARE_WRAP_MODE_V_intensityTexture [[function_constant(1079)]];
constant int SC_SOFTWARE_WRAP_MODE_V_intensityTexture_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_V_intensityTexture) ? SC_SOFTWARE_WRAP_MODE_V_intensityTexture : -1;
constant int baseTexLayout [[function_constant(1080)]];
constant int baseTexLayout_tmp = is_function_constant_defined(baseTexLayout) ? baseTexLayout : 0;
constant int deviceTexLayout [[function_constant(1081)]];
constant int deviceTexLayout_tmp = is_function_constant_defined(deviceTexLayout) ? deviceTexLayout : 0;
...
float4 deviceTexSize;
float4 deviceTexDims;
float4 deviceTexView;
float3x3 deviceTexTransform;
float4 deviceTexUvMinMax;
float4 deviceTexBorderColor;
float4 baseTexSize;
float4 baseTexDims;
float4 baseTexView;
...
float2 Port_Scale_N010;
float2 Port_Center_N010;
float depthRef;
};
struct sc_Bone_t
{
...
texture2d<float> deviceTex [[id(5)]];
...
float2 CoordsOut_N10=float2(0.0);
CoordsOut_N10=((UVCoord_N8-(*sc_set2.UserUniforms).Port_Center_N010)*(*sc_set2.UserUniforms).Port_Scale_N010)+(*sc_set2.UserUniforms).Port_Center_N010;
float4 Output_N7=float4(0.0);
int l9_7=0;
if ((int(deviceTexHasSwappedViews_tmp)!=0))
{
int l9_8=0;
if (sc_StereoRenderingMode_tmp==0)
{
...
int l9_12=l9_7;
int param=deviceTexLayout_tmp;
int param_1=l9_12;
float2 param_2=CoordsOut_N10;
bool param_3=(int(SC_USE_UV_TRANSFORM_deviceTex_tmp)!=0);
float3x3 param_4=(*sc_set2.UserUniforms).deviceTexTransform;
int2 param_5=int2(SC_SOFTWARE_WRAP_MODE_U_deviceTex_tmp,SC_SOFTWARE_WRAP_MODE_V_deviceTex_tmp);
bool param_6=(int(SC_USE_UV_MIN_MAX_deviceTex_tmp)!=0);
float4 param_7=(*sc_set2.UserUniforms).deviceTexUvMinMax;
bool param_8=(int(SC_USE_CLAMP_TO_BORDER_deviceTex_tmp)!=0);
float4 param_9=(*sc_set2.UserUniforms).deviceTexBorderColor;
float param_10=0.0;
...
float l9_82=l9_74;
float4 l9_83=sc_set2.deviceTex.sample(sc_set2.deviceTexSmpSC,l9_81,bias(l9_82));
float4 l9_84=l9_83;
float4 l9_85=l9_84;
if (param_8)
{
...
int l9_92=l9_87;
int param_11=baseTexLayout_tmp;
int param_12=l9_92;
float2 param_13=CoordsOut_N10;
bool param_14=(int(SC_USE_UV_TRANSFORM_baseTex_tmp)!=0);
float3x3 param_15=(*sc_set2.UserUniforms).baseTexTransform;
int2 param_16=int2(SC_SOFTWARE_WRAP_MODE_U_baseTex_tmp,SC_SOFTWARE_WRAP_MODE_V_baseTex_tmp);
bool param_17=(int(SC_USE_UV_MIN_MAX_baseTex_tmp)!=0);
float4 param_18=(*sc_set2.UserUniforms).baseTexUvMinMax;
bool param_19=(int(SC_USE_CLAMP_TO_BORDER_baseTex_tmp)!=0);
float4 param_20=(*sc_set2.UserUniforms).baseTexBorderColor;
float param_21=0.0;
bool l9_93=param_19&&(!param_17);
float l9_94=1.0;
float l9_95=param_13.x;
int l9_96=param_16.x;
if (l9_96==1)
{
l9_95=fract(l9_95);
}
...
float l9_107=param_13.x;
float l9_108=param_18.x;
float l9_109=param_18.z;
bool l9_110=l9_106;
float l9_111=l9_94;
...
float l9_116=param_13.y;
float l9_117=param_18.y;
float l9_118=param_18.w;
bool l9_119=l9_115;
float l9_120=l9_94;
...
float2 l9_123=param_13;
bool l9_124=param_14;
float3x3 l9_125=param_15;
if (l9_124)
{
...
param_13=l9_128;
float l9_129=param_13.x;
int l9_130=param_16.x;
bool l9_131=l9_93;
float l9_132=l9_94;
...
param_13.x=l9_129;
l9_94=l9_132;
float l9_140=param_13.y;
int l9_141=param_16.y;
bool l9_142=l9_93;
float l9_143=l9_94;
...
param_13.y=l9_140;
l9_94=l9_143;
float2 l9_151=param_13;
int l9_152=param_11;
int l9_153=param_12;
float l9_154=param_21;
...
float2 l9_161=l9_160.xy;
float l9_162=l9_154;
float4 l9_163=sc_set2.baseTex.sample(sc_set2.baseTexSmpSC,l9_161,bias(l9_162));
float4 l9_164=l9_163;
float4 l9_165=l9_164;
if (param_19)
{
l9_165=mix(param_20,l9_165,float4(l9_94));
}
float4 l9_166=l9_165;
Output_N0=l9_166;
float Output_N2=0.0;
Output_N2=Output_N0.x;
float Output_N1=0.0;
Output_N1=Output_N3*Output_N2;
float4 Value_N6=float4(0.0);
Value_N6=float4(Output_N7.xyz.x,Output_N7.xyz.y,Output_N7.xyz.z,Value_N6.w);
Value_N6.w=Output_N1;
FinalColor=Value_N6;
...
float2 l9_168=floor(mod(l9_167.xy,float2(4.0)));
float l9_169=(mod(dot(l9_168,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (param_22<l9_169)
{
discard_fragment();
}
}
bool l9_170=(*sc_set2.UserUniforms).isProxyMode!=0;
if (l9_170)
{
...
float4 l9_171=fast::max(param_23,float4(0.0));
float4 param_24=l9_171;
...
{
l9_174=fast::clamp(l9_173.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_174=fast::clamp(dot(l9_173.xyz,float3(l9_173.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_174=(1.0-dot(l9_173.xyz,float3(0.33333001)))*l9_173.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_174=(1.0-fast::clamp(dot(l9_173.xyz,float3(1.0)),0.0,1.0))*l9_173.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_174=fast::clamp(dot(l9_173.xyz,float3(1.0)),0.0,1.0)*l9_173.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_174=fast::clamp(dot(l9_173.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_174=dot(l9_173.xyz,float3(0.33333001))*l9_173.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_174=1.0-fast::clamp(dot(l9_173.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_175=l9_174;
float l9_176=l9_175;
float l9_177=(*sc_set2.UserUniforms).sc_ShadowDensity*l9_176;
float3 l9_178=mix((*sc_set2.UserUniforms).sc_ShadowColor.xyz,(*sc_set2.UserUniforms).sc_ShadowColor.xyz*l9_172.xyz,float3((*sc_set2.UserUniforms).sc_ShadowColor.w));
float4 l9_179=float4(l9_178.x,l9_178.y,l9_178.z,l9_177);
param_25=l9_179;
}
else
{
...
{
float4 l9_180=param_25;
float4 l9_181=float4(0.0);
float4 l9_182=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_183=out.FragColor0;
float4 l9_184=l9_183;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_184.x+=(*sc_set2.UserUniforms)._sc_framebufferFetchMarker;
}
float4 l9_185=l9_184;
l9_182=l9_185;
}
...
float2 l9_187=(l9_186.xy*(*sc_set2.UserUniforms).sc_WindowToViewportTransform.xy)+(*sc_set2.UserUniforms).sc_WindowToViewportTransform.zw;
...
int l9_192=l9_191;
int l9_193=l9_192;
float3 l9_194=float3(l9_188,0.0);
int l9_195=l9_190;
int l9_196=l9_193;
if (l9_195==1)
{
l9_194.y=((2.0*l9_194.y)+float(l9_196))-1.0;
}
float2 l9_197=l9_194.xy;
l9_189=l9_197;
}
else
{
...
int l9_206=l9_201;
float2 l9_207=l9_200;
int l9_208=l9_206;
float2 l9_209=l9_207;
int l9_210=l9_208;
float l9_211=0.0;
float4 l9_212=float4(0.0);
float2 l9_213=l9_209;
int l9_214=sc_ScreenTextureLayout_tmp;
int l9_215=l9_210;
float l9_216=l9_211;
...
float3 l9_222=l9_221;
float2 l9_223=l9_222.xy;
float l9_224=l9_216;
float4 l9_225=sc_set2.sc_ScreenTexture.sample(sc_set2.sc_ScreenTextureSmpSC,l9_223,bias(l9_224));
float4 l9_226=l9_225;
l9_212=l9_226;
float4 l9_227=l9_212;
float4 l9_228=l9_227;
float4 l9_229=l9_228;
l9_182=l9_229;
}
float4 l9_230=l9_182;
float4 l9_231=l9_230;
float3 l9_232=l9_231.xyz;
float3 l9_233=l9_232;
float3 l9_234=l9_180.xyz;
float3 l9_235=definedBlend(l9_233,l9_234,in.varStereoViewID,(*sc_set2.UserUniforms),sc_set2.intensityTexture,sc_set2.intensityTextureSmpSC);
l9_181=float4(l9_235.x,l9_235.y,l9_235.z,l9_181.w);
float3 l9_236=mix(l9_232,l9_181.xyz,float3(l9_180.w));
l9_181=float4(l9_236.x,l9_236.y,l9_236.z,l9_181.w);
l9_181.w=1.0;
float4 l9_237=l9_181;
param_25=l9_237;
}
else
{
float4 l9_238=param_25;
...
{
l9_243=float4((*sc_set2.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_243=float4(0.0);
...
float4 l9_245=param_28;
out.FragColor0=l9_245;
return out;
}
} // FRAGMENT SHADER
